<nav class="navbar navbar-expand-lg navbar-dark py-3">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item industries" href="?page=industries/electrical-electronic">Elektrik - Elektronik</a></li>
        <li><a class="dropdown-item industries" href="?page=industries/construction-machinery">İnşaat - Makine</a></li>
